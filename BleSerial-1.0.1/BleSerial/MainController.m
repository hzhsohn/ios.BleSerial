...
- (void)viewDidLoad {
    ...
    adView.adUnitID = @"ca-app-pub-8018207524434638/3917820100";
    [self.viwAD addSubview:adView];
   // [adView release];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.lbDevID setText:[NSString stringWithFormat:@"%s",CFStringGetCStringPtr(s, 0)]];
...
-(void)mzhBluetoothScan_cb:(CBPeripheral *)peripheral
{
    ...
    for (CBPeripheral*p in _aryPeripheral) {
        CFStringRef sr1 = CFUUIDCreateString(NULL, p.UUID);
        CFStringRef sr2 = CFUUIDCreateString(NULL, peripheral.UUID);
        NSString*s1 =[NSString stringWithFormat:@"%s",CFStringGetCStringPtr(sr1, 0)];
        NSString*s2 =[NSString stringWithFormat:@"%s",CFStringGetCStringPtr(sr2, 0)];
