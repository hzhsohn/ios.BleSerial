...
@interface SelectWriteUIDController ()
{
...
@implementation SelectWriteUIDController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.delegate SelectWriteUIDController_cb:rServ: rbuf];
